...
export default function GalleryPage() {
    return (
        <div className="min-h-screen bg-background pb-24">
            ...
            <div className="px-6 py-12 mt-8 border-t border-border/50 bg-white">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="rounded-3xl overflow-hidden shadow-lg border border-border/80 bg-surface">
                        <iframe 
