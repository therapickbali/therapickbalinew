...
export default function SeoExpandedContent() {
  return (
    <section className="mb-24 py-12 md:py-20 border-t border-white/20/30">
      <div className="max-w-3xl mx-auto text-center px-4 md:px-0">
        ...
        <p className="text-sm md:text-base text-white/90-muted leading-relaxed font-light mb-8">
