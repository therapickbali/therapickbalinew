        ...
        <div className="min-h-screen bg-background pb-24">
            ...
            <div className="px-6 py-8">
                ...
                <div className="space-y-4 mb-10">
                    ...
                    <a href="mailto:info@therapickhomespa.com" className="flex items-center gap-4 bg-surface p-5 rounded-2xl border border-border/80 active:scale-95 transition-transform">
                        ...
                        <div>
                            ...
                            <span className="font-sans font-medium text-sm text-primary">info@therapickhomespa.com</span>
                        </div>
                    </a>
