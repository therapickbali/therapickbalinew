      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-6 group outline-none">
              ...
              <span className="font-serif text-xl font-medium tracking-wide">Therapick Home Spa</span>
            </Link>
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com/therapickspa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/80 hover:bg-white hover:text-primary transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-white/70 font-light">hello@therapickhomespaubud.com</span>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/40 font-light">
            &copy; {currentYear} Therapick Home Spa. All rights reserved.
          </p>
